...
use crate::mvb_page_model::Attempts;
use crate::mvb_record_model::{AtomicVersion, Version};
use crate::mvb_utils::safe_cell::SafeCell;
use crate::mvb_utils::smart_cell::SmartFlavor::{ExclusiveCell, FreeCell, HybridCell, LightWeightHybridCell, OLCCell, ReadersWriterCell};
use crate::mvb_utils::smart_cell::SmartGuard::{HybridRwReader, HybridRwWriter, LockFree, MutExclusive, OLCAppendPin, OLCReader, OLCReaderPin, OLCWriter, RwReader, RwWriter};
...
impl<'a, E: Default + 'static> SmartGuard<'_, E> {
    ...
    pub fn deref(&self) -> Option<&'_ E> {
        match self {
            ...
            OLCAppendPin(cell, ..) => Some(cell.0.as_ref()),
    ...
    pub fn deref_mut(&self) -> Option<&mut E> {
        match self {
            ...
            OLCAppendPin(cell, ..) => Some(cell.unsafe_borrow_mut()),
            // OLCReaderPin(cell, ..) =>
            //     if let LightWeightHybridCell(opt) = cell.0.as_ref() {
