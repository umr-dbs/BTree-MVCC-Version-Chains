...
use crate::mvb_record_model::version_info::DeletedVersionInfo;
use crate::mvb_version_index::vanilla::AtomicVersionList;
use crate::mvb_version_index::version_index::VersionIndex;
...
//         Self {
//             key: self.key(),
//             mvb_version_index: self.mvb_version_index().clone(),
//         }
//     }
// }
