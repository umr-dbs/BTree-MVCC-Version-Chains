...
// use crate::mvb_page_model::{AtomicBlockID, BlockID};
use crate::mvb_block::block::Block;
use crate::mvb_page_model::internal_page::InternalPage;
use crate::mvb_page_model::leaf_page::LeafPage;
use crate::mvb_page_model::node::Node;
use crate::mvb_page_model::{BlockID, ObjectCount};
use crate::mvb_utils::smart_cell::{SmartCell, SmartFlavor};
// use crate::mvb_tree::settings::BlockSettings;

const ENABLE_SMALL_BLOCK: bool = false;
const MAX_ZEROS_PER_BLOCK: usize = 3964; // = data region in a mvb_block // outdated due to omitted mvb_block-id
      ...
      Payload: Default + Clone + Send + Sync + Display + 'static
{
        ...
        mem::align_of::<Block<0, 0, Key, Payload>>() + // alignment for mvb_block
